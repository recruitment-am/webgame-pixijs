...
function createPixiInstance(canvas: HTMLCanvasElement, dispatch: GameDispatch) {
...
export const Game = (): JSX.Element => {
  // we need to pass the game state's dispatch function down to the Game
  ...
  useEffect(() => {
    if (canvasRef.current) {
      createPixiInstance(canvasRef.current, dispatch);
    }
